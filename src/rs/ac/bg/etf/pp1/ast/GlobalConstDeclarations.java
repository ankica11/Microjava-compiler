...
public class GlobalConstDeclarations extends GlobalDeclList {

    private GlobalDeclList GlobalDeclList;
    private ConstDecl ConstDecl;

    public GlobalConstDeclarations (GlobalDeclList GlobalDeclList, ConstDecl ConstDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("GlobalConstDeclarations(\n");
