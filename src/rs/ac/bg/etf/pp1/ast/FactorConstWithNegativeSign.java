...
public class FactorConstWithNegativeSign extends Factor {

    private ConstValue ConstValue;

    public FactorConstWithNegativeSign (ConstValue ConstValue) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorConstWithNegativeSign(\n");
